...
summary(acru.run$precip.yr)
summary(acru.run$Tavg.yr)
####################################################################################################################
...
results <- anneal(overall.model, par, var, acru.run, par_lo, par_hi, dnorm, "BAI", hessian = F, slimit=1.92, max_iter=5000)
