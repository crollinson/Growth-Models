...
summary(bele.run$precip.yr)
summary(bele.run$Tavg.yr)
####################################################################################################################
...
par<-list(
		  aa=0.94, ab=0.01, gmax=1287,  	# Autogenic
          ca=1.6, cb=13.6, cc=5, cd=4.7, ce=866, cf=20, cg=4235,  # Competition
          ta1=324, tb1=415,
          pa1=641, pb1=2676, pc1=0.003,
...
par_hi <-list(
              ...
              ca=1000, cb=1000, cc=5, cd=5, ce=1000, cf=1000, cg=5000,	# Competition
