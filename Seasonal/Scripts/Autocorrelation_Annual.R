...
# ACRU
###############################
load("ACRU_Full_Season_Results.Rdata")
...
acru1 <- lm(resid ~ Year, data=results.acru$source_data)
summary(acru1)
...
# BELE
###############################
load("BELE_Full_Season_Results.Rdata")
...
bele1 <- lm(resid ~ Year, data=results.bele$source_data)
summary(bele1)

bele2 <- aov(resid ~ TreeID, data=results.bele$source_data)
summary(bele2)
...
# NYSY
###############################
load("NYSY_Full_Season_Results.Rdata")
...
# QURU
###############################
load("QURU_Full_Season_Results.Rdata")
...
quru1 <- lm(resid ~ Year, data=results.quru$source_data)
summary(quru1)

quru2 <- aov(resid ~ TreeID, data=results.quru$source_data)
summary(quru2)

quru3 <- aov(resid ~ PlotID, data=results.quru$source_data)
summary(quru3)

quru4 <- aov(resid ~ Site, data=results.quru$source_data)
summary(quru4)
...
# QUPR
###############################
load("QUPR_Full_Season_Results.Rdata")
